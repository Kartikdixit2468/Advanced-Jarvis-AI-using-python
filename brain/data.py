training_data = [
    ...
    ("save a picture of an artistic painting", "scrap images"),
        ...
        ("Take a screenshot now.", "screenshot"),
    ("Capture the current screen.", "screenshot"),
    ("Grab a screenshot, please.", "screenshot"),
    ("Save a screenshot of this window.", "screenshot"),
    ("Record the screen and save as an image.", "screenshot"),
    ("Snap a picture of the desktop.", "screenshot"),
    ("I want to capture what's on my screen.", "screenshot"),
    ("Take a screenshot of the entire display.", "screenshot"),
    ("Save an image of the active window.", "screenshot"),
    ("Capture and save the screen content.", "screenshot"),
    ("Grab a snapshot of the current view.", "screenshot"),
    ("Screenshot, please.", "screenshot"),
    ("Record the screen and save it as a picture.", "screenshot"),
    ("I need a screenshot of this moment.", "screenshot"),
    ("Take a picture of the screen now.", "screenshot"),
    ("Snap a shot of what's on my monitor.", "screenshot"),
    ("Capture the display and save as an image file.", "screenshot"),
    ("Save a screenshot of the entire screen.", "screenshot"),
    ("Screenshot this for me.", "screenshot"),
    ("Capture what's on my screen right now.", "screenshot"),
    # Add more examples if needed
    ...
    ("Can you provide the current time?", "date_time"),
